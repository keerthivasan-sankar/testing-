...
def test_keyset_export_import_round_trip_classical():
    engine = PolicyEngine()
    keyset = establish_keys(engine, constraint=Constraint.FAST)
    ...
    # Verify imported keyset can decrypt payloads encrypted for original bundle
    plaintext = b"Test Keystore Import Functional Roundtrip"
